    ...
    <section className="container-fluid pt-3">
        <div className="row justify-content-center">
            <div className="row justify-content-center pt-2">
                <img className="col-sm-6 col-md-4 col-lg-1 feature-img" src="https://i.imgur.com/tnf9tDK.jpg" alt="" srcset="" />
            ...
            <div className="row justify-content-center pt-2">
                <img className="col-3 col-lg-1 feature-img" src="https://i.imgur.com/tnf9tDK.jpg" alt="" srcset="" />
                <div className="col-6">
